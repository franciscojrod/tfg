...
# Build project theme.
npm run setup || error_exit "Npm task setup failed."
npm run build:pl && npm run build:drupal || error_exit "Npm task build failed."
#npm run ci || error_exit "Npm build task failed."
